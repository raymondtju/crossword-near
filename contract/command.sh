...
# batch actions -> init when deploy to prevent someone execute the code first
near deploy crossword.ferro.testnet ./target/wasm32-unknown-unknown/release/crossword_near.wasm --initFunction 'new' --initArgs "{\"solution\": \"3f1eced51bac0cb5351bb7c40eacb93146935a0490e7e2d24d177789a3a76e31\"}"